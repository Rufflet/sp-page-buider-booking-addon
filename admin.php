...
SpAddonsConfig::addonConfig(
	array(
		'type'=>'content',
		'addon_name'=>'sp_booking',
		'title'=>'Calendar Booking',
		'desc'=>'SP Calendar Booking Addon',
		'attr'=>array(
			'general' => array(
				...
				'from_name'=>array(
					'type'=>'text',
					'title'=>'From Name',
					'desc'=>'Enter the from name. This field is optional.',
					'std'=>''
				),
				...
				'from_email'=>array(
					'type'=>'text',
					'title'=>'From Email',
					'desc'=>'Enter the from email address. This field is optional.',
					'std'=>''
				),
